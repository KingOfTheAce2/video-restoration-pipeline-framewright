...
class VastAIProvider(CloudProvider):
    ...
    def _try_submit_with_offer(self, job_id: str, offer_id: int, config: ProcessingConfig) -> str:
        ...
        try:
            ...
            # Add paths to env_vars for the setup script
            env_vars["FRAMES_OUTPUT_PATH"] = frames_output_path
            env_vars["UNIQUE_FRAMES_PATH"] = unique_frames_path
            env_vars["LOGS_PATH"] = f"{output_base}_logs/"
            env_vars["RESTORE_CMD"] = restore_cmd
