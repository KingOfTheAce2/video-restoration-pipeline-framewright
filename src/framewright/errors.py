"""Legacy error handling module for FrameWright.

DEPRECATED: This module is maintained for backward compatibility.
Please import from `framewright.core.errors` instead.

All exceptions and utilities have been consolidated into the unified
error handling system at `framewright.core.errors`.
"""
...
def _emit_deprecation_warning() -> None:
    ...
    warnings.warn(
        "framewright.errors is deprecated. "
        "Please import from framewright.core.errors instead.",
        DeprecationWarning,
        stacklevel=3,
    )
